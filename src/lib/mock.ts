...
export const FILIAIS: Filial[] = [
  {
    ...
    uf: "PA",
    cd: true,
    bling: { conta: "nexus-matriz", status: "conectado", sync: "há 5 min" },
  },
  {
    id: "pa",
    nome: "Filial PA",
    uf: "PA",
    bling: { conta: "nexus-pa", status: "conectado", sync: "há 12 min" },
  },
  {
    id: "sc",
    nome: "Filial SC",
    uf: "SC",
    bling: { conta: "nexus-sc", status: "conectado", sync: "há 8 min" },
  },
  {
    id: "sp",
    nome: "Filial SP",
    uf: "SP",
    bling: { conta: "nexus-sp", status: "erro", sync: "falha há 2h" },
  },
];
