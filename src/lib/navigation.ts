...
export const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "ferramentas-descontos", href: "/ferramentas/descontos", label: "Descontos Inteligentes", icon: BadgePercent },
      { id: "ferramentas-marketplace", href: "/ferramentas/marketplaces", label: "Marketplaces", icon: Store },
      { id: "ferramentas-ecommerce", href: "/ferramentas/ecommerce", label: "E-commerce", icon: ShoppingBag },
      { id: "ferramentas-fracionada", href: "/ferramentas/fracionada", label: "Fracionada", icon: Scissors },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "ruptura", href: "/relatorios/ruptura", label: "Ruptura Geral", icon: AlertTriangle },
