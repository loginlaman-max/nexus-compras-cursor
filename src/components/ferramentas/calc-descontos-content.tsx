...
export function CalcDescontosContent() {
  ...
  const margDesejado =
    pvDesejado > 0 ? ((pvDesejado - c) / pvDesejado) * 100 : 0;
    ...
    <div className="nx-calc-grid">
      <div className="card nx-calc-form">
        ...
        <div className="nx-calc-margnow">
          ...
          <strong className={margAtual >= mm ? "is-ok" : "is-bad"}>
            {tbPct(margAtual)}
          </strong>
        </div>
        <CalcField
      ...
      <div className="nx-calc-out">
        ...
        <div className="nx-calc-stats">
          <CalcStat
            ...
            value={tbBRL(pvDesejado)}
            sub={`${tbPct(dd)} off`}
          />
          <CalcStat
            label="Margem resultante"
            value={tbPct(margDesejado)}
            tone={desejadoOk ? "ok" : "bad"}
          />
        </div>
